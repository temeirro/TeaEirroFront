            ...
            >
                <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                    <li >
                        <Link
                            to="/profile"
                            className="flex mb-3 items-center gap-3.5 text-xs font-light p-2 mt-3 duration-300 ease-in-out hover:text-primary lg:text-base"
                        >
                            <svg
                    ...
                    {user?.role == 'admin' && (
                        <li>
                            <Link
                                to="/admin"
                                className="flex items-center gap-3.5 text-xs font-light m-2 mt-3 mb-5 duration-300 ease-in-out hover:text-primary lg:text-base"
                            >
                ...
                <button onClick={handleLogout} className="flex items-center gap-3.5 py-4 px-6 text-xs font-light m-2 duration-300 ease-in-out hover:text-primary lg:text-base">
                    <svg
                        className="fill-current"
                        width="22"
                        height="22"
