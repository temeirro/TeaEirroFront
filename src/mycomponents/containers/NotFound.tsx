        ...
        <section className="bg-auto dark:bg-gray-900 ">
            <div className=" container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
                <div className="wf-ull lg:w-1/2">
                    ...
                    <p className="mt-4 text-white dark:text-gray-400">Вибачте, ми втратили цю сторінку</p>
                    ...
                    <div className="flex items-center mt-6 gap-x-3">
                        ...
                        <button className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-400 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                            Додому
                        </button>
                    </div>
                </div>
